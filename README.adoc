...
You can generate your Antora-based site (with search bar and static search index file) with the following command:
 ...
 $ DOCSEARCH_INDEX_VERSION=latest DOCSEARCH_ENABLED=true NODE_PATH="$(npm -g root)" antora --generator antora-site-generator-lunr antora-playbook.yml --to-dir docs/output --cache-dir=./.cache
